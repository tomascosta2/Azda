		...
		<div className="relative">
			...
			<div className="h-full pb-[60px] overflow-hidden">
				...
				<section className="relative z-40 max-w-[1200px] mx-auto pt-[60px] lg:pt-[50px] px-4">
					...
					<h1 className="text-center text-[29px] md:text-[56px] tracking-tight font-extrabold leading-[110%] max-w-[1100px] mx-auto my-[20px]">Escalamos tu negocio de coaching/consultoría de manera predecible y sostenible en el tiempo.</h1>
