	...
	const STEPS: Step[] = [
		{
			...
			imgUrl: "/images/azda-paso-1.webp"
		},
		{
			...
			imgUrl: "/images/azda-paso-2.webp"
		},
		{
		...
		},
		{
			...
			imgUrl: "/images/azda-paso-5.webp",
		},
		{
						...
						STEPS.map((step, i) => {
							...
							return (
								<div className="grid lg:grid-cols-2 gap-[20px] lg:gap-[35px] mb-[45px] last:mb-0 lg:h-[250px]">
									...
									<img 
										className={`max-w-[500px] mx-auto w-full h-full rounded-[8px] ${i % 2 === 0 ? 'appear-from-right -order-1 lg:order-2' : 'appear-from-left -order-1'}`} 
										src={step.imgUrl} 
