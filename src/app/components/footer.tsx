		...
		<>
			<footer className="pt-[40px] px-4 relative foregroundColor">
				<div className="tc-container">
					<div className="flex gap-[20px] flex-wrap md:flex-nowrap items-center justify-center md:justify-between mb-[30px]">
						<div className="flex items-center md:items-start flex-col w-[350px] text-[14px] text-white/80">
							<Logo/>
							<p className="mt-[12px] text-center md:text-start">Azda Corporation, es tu aliado estratégico enfocado a impulsar tu negocio de Coaching o Consultoría hacia el éxito.</p>
						</div>
