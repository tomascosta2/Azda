	...
	return (
		<div className="relative px-4">
			...
			<section className="relative z-40 max-w-[1200px] mx-auto pt-[60px] lg:pt-[90px] px-4">
				...
				<h1 className="text-center text-29px md:text-[55px] font-extrabold leading-[110%] max-w-[1100px] mx-auto my-[20px] text-pretty">Escalamos tu negocio a $7.500 USD implementando estrategias que ya han funcionado para más de 100 profesionales como tú.</h1>
