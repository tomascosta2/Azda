	...
	return (
		<div className="relative px-4">
			...
			<section className="relative z-40 max-w-[1200px] mx-auto pt-[60px] lg:pt-[90px] px-4">
				...
				<h1 className="text-center text-[55px] font-extrabold leading-[110%] max-w-[1100px] mx-auto my-[20px]">Escalamos tu negocio de coaching/consultoría de manera predecible y sostenible en el tiempo.</h1>
