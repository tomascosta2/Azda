	...
	return (
		<div className="relative px-4">
			...
			<section className="relative z-40 max-w-[1200px] mx-auto pt-[60px] lg:pt-[90px] px-4">
				<span className="block mx-auto --sora text-[18px] md:text-[22px] font-semibold text-center text-white/80">¿que tu facturación mensual sea variable no te deja estar tranquilo?</span>
				<h1 className="text-center text-29px md:text-[55px] font-extrabold leading-[110%] max-w-[1100px] mx-auto my-[20px]">Escalamos tu negocio de coaching/consultoría de manera predecible y sostenible en el tiempo.</h1>
