	...
	return (
		<div className="relative px-4">
			...
			<section className="relative z-40 max-w-[1200px] mx-auto pt-[90px] px-4">
				...
				<h1 className="text-center text-[60px] font-extrabold leading-[110%] max-w-[1100px] mx-auto my-[20px]">Escalamos la facturación de tu negocio de coaching o consultoría de manera predecible y sostenible en el tiempo.</h1>
