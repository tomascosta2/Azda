			...
			<div className="max-w-[1200px] mx-auto px-4">
				...
				<div className="lg:max-w-[50%] 2xl:max-w-[60%]">
					...
					<p className="normal-case text-white/90 font-medium text-[16px] text-justify">
						Azda Corporation, es tu aliado estratégico enfocado a impulsar <strong>tu negocio de Coaching o Consultoría hacia el éxito</strong>. Nuestra misión es clara: proporcionarte la información, sistemas, equipo y el expertise necesarios para alcanzar tus metas.
						<br /><br />
						...
						<br /><br />
						Somos expertos en soluciones digitales a medida para el mercado de Coaching y Consultores. Con un <strong>equipo de profesionales apasionados</strong>, diseñamos embudos de adquisición de clientes altamente efectivos y estrategias de posicionamiento de marca que <strong>te convertirán en un referente en tu rubro</strong>.
						<br /><br />
						<strong>No somos simplemente un proveedor de servicios, sino tus socios en el crecimiento.</strong>
						<br /><br />
						Priorizamos la personalización y nos aseguramos de que cada socio con el que trabajemos obtenga <strong>resultados óptimos y eficientes</strong>.
					</p>
				</div>
			</div>
		</section>
