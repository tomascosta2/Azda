export default function Agenda () {
	return (
		<section className="foregroundColor py-[100px] px-4 relative">
			<div className="tc-container">
				<h2 className="max-w-[1000px] mx-auto leading-[110%] text-center text-[36px] lg:text-[42px] text-white font-extrabold">Si quieres llegar a nuevos clientes todos los meses, aumentar tu facturación y por fin estar tranquilo sin depender de tu mercado cálido pero no sabes como...</h2>
				...
				<h3 className="tcp-underline --4 w-fit mx-auto leading-[110%] text-center text-[30px] lg:text-[36px] text-white font-extrabold mb-[30px] lg:mb-0">AGENDA TU SESIÓN DE CONSULTORÍA GRATUITA</h3>
