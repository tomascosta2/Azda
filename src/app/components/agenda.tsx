	...
	return (
		<section id="calendlyDos" className="foregroundColor py-[60px] lg:py-[100px] px-4 relative">
			<div className="tc-container">
				<h2 className="max-w-[1000px] mx-auto leading-[110%] text-center text-[30px] lg:text-[42px] text-white font-extrabold">Si estas cansado de depender de tu mercado calido y de no tener estabilidad pero te sentis abrumado por que no sabes como mejorarlo.</h2>
				...
				<h3 className="w-fit mx-auto leading-[110%] text-center text-[30px] lg:text-[36px] text-white font-extrabold mb-[30px] lg:mb-0">AGENDA TU SESIÓN DE <span>CONSULTORÍA GRATUITA</span></h3>
