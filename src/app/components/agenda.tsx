			...
			<div className="tc-container">
				...
				<div className="flex flex-col-reverse md:flex-row justify-center gap-[40px] lg:pt-[50px]">
					...
					<div className="relative bg-white lg:px-[40px] lg:py-[20px] lg:rounded-[8px]">
						<div className="relative z-40 w-[450px] max-w-full calendly-inline-widget" data-url="https://calendly.com/vicente-calderon/consultoria?hide_event_type_details=1&hide_gdpr_banner=1" style={{minWidth:'320px', height:'500px'}}></div>
					</div>
				</div>
			</div>
		</section>
