	...
	return (
		<section id="calendlyDos" className="foregroundColor py-[60px] lg:py-[100px] px-4 relative">
			<div className="tc-container">
				<h2 className="max-w-[1000px] mx-auto leading-[110%] text-center text-[30px] lg:text-[42px] text-white font-extrabold">Si estas cansado de no poder llegar a nuevos clientes calificados todos los meses pero te sentís abrumado por que no sabes como mejorarlo</h2>
